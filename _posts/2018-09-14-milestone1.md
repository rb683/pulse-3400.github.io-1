...
We adapted our functions from Lab 1 to get the robot to follow a line and move in a figure eight. To help us do this, we created a state machine. Here is an image of the state machine:
...
When the robot reached an intersection, we turned right and left by writing methods to change the speed of the servos:
```
// code goes here
```
...
<p align="center">
  <img src="images/chloe1.jpg" width="700px" height="396px"/><br/>
...
<p align="center">
  <img src="images/sidalex1.jpg" width="700px" height="396px"/><br/>
